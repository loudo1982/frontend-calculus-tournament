      ...
      seeds: [
        {
          id: 1,
          date: 'Room 1',
          teams: [{ name: equipos[25]}, { name:  equipos[3] }],
        },
        {
          id: 2,
          date: 'Room 2',
          teams: [{ name: equipos[22] }, { name: equipos[0] }],
        },
        {
          id: 3,
          date: 'Room 3',
          teams: [{ name: equipos[31]}, { name:  equipos[21] }],
        },
        {
          id: 4,
          date: 'Room 5',
          teams: [{ name: equipos[5] }, { name: equipos[28] }],
        },
        {
          id: 5,
          date:'Room 5',
          teams: [{ name: equipos[2]}, { name:  equipos[18] }],
        },
        {
          id: 6,
          date: 'Room 6',
          teams: [{ name: equipos[6] }, { name: equipos[30] }],
        },
        {
          id: 7,
          date: 'Room 7',
          teams: [{ name: equipos[24]}, { name:  equipos[13] }],
        },
        {
          id: 8,
          date: 'Room 8',
          teams: [{ name: equipos[14] }, { name: equipos[29] }],
        },
        {
          id: 9,
          date: 'Room 9',
          teams: [{ name: equipos[8]}, { name:  equipos[26] }],
        },
        {
          id: 10,
          date:'Room 10',
          teams: [{ name: equipos[9] }, { name: equipos[27] }],
        },
        {
          id: 11,
          date: 'Room 11',
          teams: [{ name: equipos[10]}, { name:  equipos[20] }],
        },
        {
          id: 12,
          date:'Room 12',
          teams: [{ name: equipos[11] }, { name: equipos[19] }],
        },
        {
          id: 13,
          date: 'Room 13',
          teams: [{ name: equipos[1]}, { name:  equipos[17] }],
        },
        {
          id: 14,
          date:'Room 14',
          teams: [{ name: equipos[7] }, { name: equipos[12] }],
        },
        {
          id: 15,
          date: 'Room 15',
          teams: [{ name: equipos[4]}, { name:  equipos[15] }],
        },
        {
          id: 16,
          date: 'Room 16',
